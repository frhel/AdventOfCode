...
// character
const packets = fs.readFileSync('../data', 'utf8').split('\n');
...
// for part 2
let correct_indices = process_packet_indices(eval_packets.slice());
let part_1_answer = correct_indices.reduce((a, b) => a + b, 0);
console.log(`Part 1: ${part_1_answer}`);

// -------------------------------- Part 2 ------------------------------------
let all_packets = eval_packets.slice().concat(divider_packets);
